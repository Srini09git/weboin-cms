...
export interface ApiPortfolioPortfolio extends Schema.CollectionType {
  ...
  attributes: {
    PortfolioMain: Attribute.Component<'portfolio.maincontent', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiServiceDataServiceData extends Schema.CollectionType {
  collectionName: 'service_datas';
  info: {
    singularName: 'service-data';
    pluralName: 'service-datas';
    displayName: 'Service';
    description: '';
  };
  options: {
  ...
  attributes: {
    secdm: Attribute.Component<'service.sec-dm', true>;
    maindm: Attribute.Component<'service.main-dm', true>;
    testimonial: Attribute.Component<'service.testimonial', true>;
    title: Attribute.Component<'service.title'>;
    getintouch: Attribute.Component<'service.getintouch'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
